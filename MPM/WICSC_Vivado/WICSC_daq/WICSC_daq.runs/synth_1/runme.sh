...
HD_PWD='C:/Users/Meklarn/Desktop/EXJOBB/JonasHansson_2021VT/Vivado/WICSC_daq/WICSC_daq.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log WICSC_daq_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source WICSC_daq_wrapper.tcl
