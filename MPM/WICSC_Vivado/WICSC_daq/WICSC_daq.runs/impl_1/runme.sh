...
HD_PWD='C:/Users/Meklarn/Desktop/EXJOBB/JonasHansson_2021VT/Vivado/WICSC_daq/WICSC_daq.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log WICSC_daq_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source WICSC_daq_wrapper.tcl -notrace
