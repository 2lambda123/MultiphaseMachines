...
HD_PWD='C:/MPM_Zynq/quadrature_decoder_v1/quadrature_decoder_v1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log quadrature_decoder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source quadrature_decoder.tcl
