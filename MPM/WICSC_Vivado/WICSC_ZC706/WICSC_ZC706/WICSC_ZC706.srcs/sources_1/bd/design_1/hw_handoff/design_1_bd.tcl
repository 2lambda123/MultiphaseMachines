...
proc create_root_design { parentCell } {
  ...
  set lvds_data_c2_n_2 [ create_bd_port -dir I lvds_data_c2_n_2 ]
  set lvds_data_c2_p_0 [ create_bd_port -dir I lvds_data_c2_p_0 ]
  set lvds_data_c2_p_1 [ create_bd_port -dir I lvds_data_c2_p_1 ]
  set lvds_data_c2_p_2 [ create_bd_port -dir I lvds_data_c2_p_2 ]
  ...
  set lvds_data_d2_n_2 [ create_bd_port -dir I lvds_data_d2_n_2 ]
  set lvds_data_d2_p_0 [ create_bd_port -dir I lvds_data_d2_p_0 ]
  set lvds_data_d2_p_1 [ create_bd_port -dir I lvds_data_d2_p_1 ]
  set lvds_data_d2_p_2 [ create_bd_port -dir I lvds_data_d2_p_2 ]
  ...
  set tsc_0 [ create_bd_port -dir O tsc_0 ]
  ...
  connect_bd_net -net MSBs_selector_0_data_out_a1 [get_bd_pins MSBs_selector_0/data_out_a1] [get_bd_pins PS_Interface_TOP_0/adc_0]
  connect_bd_net -net MSBs_selector_0_data_out_a2 [get_bd_pins MSBs_selector_0/data_out_a2] [get_bd_pins PS_Interface_TOP_0/adc_1]
  connect_bd_net -net MSBs_selector_0_data_out_b1 [get_bd_pins MSBs_selector_0/data_out_b1] [get_bd_pins PS_Interface_TOP_0/adc_2]
  connect_bd_net -net MSBs_selector_0_data_out_b2 [get_bd_pins MSBs_selector_0/data_out_b2] [get_bd_pins PS_Interface_TOP_0/adc_3]
  connect_bd_net -net MSBs_selector_0_data_out_c1 [get_bd_pins MSBs_selector_0/data_out_c1] [get_bd_pins PS_Interface_TOP_0/adc_4]
  connect_bd_net -net MSBs_selector_0_data_out_c2 [get_bd_pins MSBs_selector_0/data_out_c2] [get_bd_pins PS_Interface_TOP_0/adc_5]
  connect_bd_net -net MSBs_selector_0_data_out_d1 [get_bd_pins MSBs_selector_0/data_out_d1] [get_bd_pins PS_Interface_TOP_0/adc_6]
  connect_bd_net -net MSBs_selector_0_data_out_d2 [get_bd_pins MSBs_selector_0/data_out_d2] [get_bd_pins PS_Interface_TOP_0/adc_7]
  connect_bd_net -net MSBs_selector_0_data_out_e1 [get_bd_pins MSBs_selector_0/data_out_e1] [get_bd_pins PS_Interface_TOP_0/adc_8]
  connect_bd_net -net MSBs_selector_0_data_out_e2 [get_bd_pins MSBs_selector_0/data_out_e2] [get_bd_pins PS_Interface_TOP_0/adc_9]
  connect_bd_net -net MSBs_selector_0_data_out_f1 [get_bd_pins MSBs_selector_0/data_out_f1] [get_bd_pins PS_Interface_TOP_0/adc_10]
  connect_bd_net -net MSBs_selector_0_data_out_f2 [get_bd_pins MSBs_selector_0/data_out_f2] [get_bd_pins PS_Interface_TOP_0/adc_11]
  connect_bd_net -net MSBs_selector_0_data_out_g1 [get_bd_pins MSBs_selector_0/data_out_g1] [get_bd_pins PS_Interface_TOP_0/adc_12]
  connect_bd_net -net MSBs_selector_0_data_out_g2 [get_bd_pins MSBs_selector_0/data_out_g2] [get_bd_pins PS_Interface_TOP_0/adc_13]
  connect_bd_net -net MSBs_selector_0_data_out_h1 [get_bd_pins MSBs_selector_0/data_out_h1] [get_bd_pins PS_Interface_TOP_0/adc_14]
  connect_bd_net -net MSBs_selector_0_data_out_h2 [get_bd_pins MSBs_selector_0/data_out_h2] [get_bd_pins PS_Interface_TOP_0/adc_15]
  connect_bd_net -net MSBs_selector_1_data_out_a1 [get_bd_pins MSBs_selector_1/data_out_a1] [get_bd_pins PS_Interface_TOP_0/adc_16]
  connect_bd_net -net MSBs_selector_1_data_out_a2 [get_bd_pins MSBs_selector_1/data_out_a2] [get_bd_pins PS_Interface_TOP_0/adc_17]
  connect_bd_net -net MSBs_selector_1_data_out_b1 [get_bd_pins MSBs_selector_1/data_out_b1] [get_bd_pins PS_Interface_TOP_0/adc_18]
  connect_bd_net -net MSBs_selector_1_data_out_b2 [get_bd_pins MSBs_selector_1/data_out_b2] [get_bd_pins PS_Interface_TOP_0/adc_19]
  connect_bd_net -net MSBs_selector_1_data_out_c1 [get_bd_pins MSBs_selector_1/data_out_c1] [get_bd_pins PS_Interface_TOP_0/adc_20]
  connect_bd_net -net MSBs_selector_1_data_out_c2 [get_bd_pins MSBs_selector_1/data_out_c2] [get_bd_pins PS_Interface_TOP_0/adc_21]
  connect_bd_net -net MSBs_selector_1_data_out_d1 [get_bd_pins MSBs_selector_1/data_out_d1] [get_bd_pins PS_Interface_TOP_0/adc_22]
  connect_bd_net -net MSBs_selector_1_data_out_d2 [get_bd_pins MSBs_selector_1/data_out_d2] [get_bd_pins PS_Interface_TOP_0/adc_23]
  connect_bd_net -net MSBs_selector_1_data_out_e1 [get_bd_pins MSBs_selector_1/data_out_e1] [get_bd_pins PS_Interface_TOP_0/adc_24]
  connect_bd_net -net MSBs_selector_1_data_out_e2 [get_bd_pins MSBs_selector_1/data_out_e2] [get_bd_pins PS_Interface_TOP_0/adc_25]
  connect_bd_net -net MSBs_selector_1_data_out_f1 [get_bd_pins MSBs_selector_1/data_out_f1] [get_bd_pins PS_Interface_TOP_0/adc_26]
  connect_bd_net -net MSBs_selector_1_data_out_f2 [get_bd_pins MSBs_selector_1/data_out_f2] [get_bd_pins PS_Interface_TOP_0/adc_27]
  connect_bd_net -net MSBs_selector_1_data_out_g1 [get_bd_pins MSBs_selector_1/data_out_g1] [get_bd_pins PS_Interface_TOP_0/adc_28]
  connect_bd_net -net MSBs_selector_1_data_out_g2 [get_bd_pins MSBs_selector_1/data_out_g2] [get_bd_pins PS_Interface_TOP_0/adc_29]
  connect_bd_net -net MSBs_selector_1_data_out_h1 [get_bd_pins MSBs_selector_1/data_out_h1] [get_bd_pins PS_Interface_TOP_0/adc_30]
  connect_bd_net -net MSBs_selector_1_data_out_h2 [get_bd_pins MSBs_selector_1/data_out_h2] [get_bd_pins PS_Interface_TOP_0/adc_31]
  connect_bd_net -net MSBs_selector_2_data_out_a1 [get_bd_pins MSBs_selector_2/data_out_a1] [get_bd_pins PS_Interface_TOP_0/adc_32]
  connect_bd_net -net MSBs_selector_2_data_out_a2 [get_bd_pins MSBs_selector_2/data_out_a2] [get_bd_pins PS_Interface_TOP_0/adc_33]
  connect_bd_net -net MSBs_selector_2_data_out_b1 [get_bd_pins MSBs_selector_2/data_out_b1] [get_bd_pins PS_Interface_TOP_0/adc_34]
  connect_bd_net -net MSBs_selector_2_data_out_b2 [get_bd_pins MSBs_selector_2/data_out_b2] [get_bd_pins PS_Interface_TOP_0/adc_35]
  connect_bd_net -net MSBs_selector_2_data_out_c1 [get_bd_pins MSBs_selector_2/data_out_c1] [get_bd_pins PS_Interface_TOP_0/adc_36]
  ...
  connect_bd_net -net PS_Interface_TOP_0_PS_IN [get_bd_pins PS_Interface_TOP_0/PS_IN] [get_bd_pins processing_system7_0/GPIO_I]
  connect_bd_net -net PS_Interface_TOP_0_toMod1 [get_bd_pins PS_Interface_TOP_0/toMod1] [get_bd_pins modulater_14bit_0/mod_input1]
  connect_bd_net -net PS_Interface_TOP_0_toMod2 [get_bd_pins PS_Interface_TOP_0/toMod2] [get_bd_pins modulater_14bit_0/mod_input2_adress]
  ...
  connect_bd_net -net fpga_dig_top_2_captured_data_c2 [get_bd_pins MSBs_selector_2/data_in_c2] [get_bd_pins fpga_dig_top_2/captured_data_c2]
  connect_bd_net -net fpga_dig_top_2_captured_data_d1 [get_bd_pins MSBs_selector_2/data_in_d1] [get_bd_pins fpga_dig_top_2/captured_data_d1]
  connect_bd_net -net fpga_dig_top_2_captured_data_d2 [get_bd_pins MSBs_selector_2/data_in_d2] [get_bd_pins fpga_dig_top_2/captured_data_d2]
  connect_bd_net -net fpga_dig_top_2_captured_data_e1 [get_bd_pins MSBs_selector_2/data_in_e1] [get_bd_pins fpga_dig_top_2/captured_data_e1]
  connect_bd_net -net fpga_dig_top_2_captured_data_e2 [get_bd_pins MSBs_selector_2/data_in_e2] [get_bd_pins fpga_dig_top_2/captured_data_e2]
  connect_bd_net -net fpga_dig_top_2_captured_data_f1 [get_bd_pins MSBs_selector_2/data_in_f1] [get_bd_pins fpga_dig_top_2/captured_data_f1]
  connect_bd_net -net fpga_dig_top_2_captured_data_f2 [get_bd_pins MSBs_selector_2/data_in_f2] [get_bd_pins fpga_dig_top_2/captured_data_f2]
  connect_bd_net -net fpga_dig_top_2_captured_data_g1 [get_bd_pins MSBs_selector_2/data_in_g1] [get_bd_pins fpga_dig_top_2/captured_data_g1]
  connect_bd_net -net fpga_dig_top_2_captured_data_g2 [get_bd_pins MSBs_selector_2/data_in_g2] [get_bd_pins fpga_dig_top_2/captured_data_g2]
  connect_bd_net -net fpga_dig_top_2_captured_data_h1 [get_bd_pins MSBs_selector_2/data_in_h1] [get_bd_pins fpga_dig_top_2/captured_data_h1]
  connect_bd_net -net fpga_dig_top_2_captured_data_h2 [get_bd_pins MSBs_selector_2/data_in_h2] [get_bd_pins fpga_dig_top_2/captured_data_h2]
  ...
  connect_bd_net -net lvds_data_c2_n_2_1 [get_bd_ports lvds_data_c2_n_2] [get_bd_pins fpga_dig_top_2/lvds_data_c2_n]
  ...
  connect_bd_net -net lvds_data_c2_p_2_1 [get_bd_ports lvds_data_c2_p_2] [get_bd_pins fpga_dig_top_2/lvds_data_c2_p]
  ...
  connect_bd_net -net lvds_data_d1_n_2_1 [get_bd_ports lvds_data_d1_n_2] [get_bd_pins fpga_dig_top_2/lvds_data_d1_n]
  ...
  connect_bd_net -net lvds_data_d1_p_2_1 [get_bd_ports lvds_data_d1_p_2] [get_bd_pins fpga_dig_top_2/lvds_data_d1_p]
  ...
  connect_bd_net -net lvds_data_d2_n_2_1 [get_bd_ports lvds_data_d2_n_2] [get_bd_pins fpga_dig_top_2/lvds_data_d2_n]
  ...
  connect_bd_net -net lvds_data_d2_p_2_1 [get_bd_ports lvds_data_d2_p_2] [get_bd_pins fpga_dig_top_2/lvds_data_d2_p]
  ...
  connect_bd_net -net lvds_data_e1_n_2_1 [get_bd_ports lvds_data_e1_n_2] [get_bd_pins fpga_dig_top_2/lvds_data_e1_n]
  ...
  connect_bd_net -net lvds_data_e1_p_2_1 [get_bd_ports lvds_data_e1_p_2] [get_bd_pins fpga_dig_top_2/lvds_data_e1_p]
  ...
  connect_bd_net -net lvds_data_e2_n_2_1 [get_bd_ports lvds_data_e2_n_2] [get_bd_pins fpga_dig_top_2/lvds_data_e2_n]
  ...
  connect_bd_net -net lvds_data_e2_p_2_1 [get_bd_ports lvds_data_e2_p_2] [get_bd_pins fpga_dig_top_2/lvds_data_e2_p]
  ...
  connect_bd_net -net lvds_data_f1_n_2_1 [get_bd_ports lvds_data_f1_n_2] [get_bd_pins fpga_dig_top_2/lvds_data_f1_n]
  ...
  connect_bd_net -net lvds_data_f1_p_2_1 [get_bd_ports lvds_data_f1_p_2] [get_bd_pins fpga_dig_top_2/lvds_data_f1_p]
  ...
  connect_bd_net -net lvds_data_f2_n_2_1 [get_bd_ports lvds_data_f2_n_2] [get_bd_pins fpga_dig_top_2/lvds_data_f2_n]
  ...
  connect_bd_net -net lvds_data_f2_p_2_1 [get_bd_ports lvds_data_f2_p_2] [get_bd_pins fpga_dig_top_2/lvds_data_f2_p]
  ...
  connect_bd_net -net lvds_data_g1_n_2_1 [get_bd_ports lvds_data_g1_n_2] [get_bd_pins fpga_dig_top_2/lvds_data_g1_n]
  ...
  connect_bd_net -net lvds_data_g1_p_2_1 [get_bd_ports lvds_data_g1_p_2] [get_bd_pins fpga_dig_top_2/lvds_data_g1_p]
  ...
  connect_bd_net -net lvds_data_g2_n_2_1 [get_bd_ports lvds_data_g2_n_2] [get_bd_pins fpga_dig_top_2/lvds_data_g2_n]
  ...
  connect_bd_net -net lvds_data_g2_p_2_1 [get_bd_ports lvds_data_g2_p_2] [get_bd_pins fpga_dig_top_2/lvds_data_g2_p]
  ...
  connect_bd_net -net lvds_data_h1_n_2_1 [get_bd_ports lvds_data_h1_n_2] [get_bd_pins fpga_dig_top_2/lvds_data_h1_n]
  ...
  connect_bd_net -net lvds_data_h1_p_2_1 [get_bd_ports lvds_data_h1_p_2] [get_bd_pins fpga_dig_top_2/lvds_data_h1_p]
  ...
  connect_bd_net -net lvds_data_h2_n_2_1 [get_bd_ports lvds_data_h2_n_2] [get_bd_pins fpga_dig_top_2/lvds_data_h2_n]
  ...
  connect_bd_net -net lvds_data_h2_p_2_1 [get_bd_ports lvds_data_h2_p_2] [get_bd_pins fpga_dig_top_2/lvds_data_h2_p]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_gpio_2/s_axi_aresetn] [get_bd_pins axi_gpio_3/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net spi3_WICSC_top_0_busy [get_bd_ports busy_0] [get_bd_pins spi3_WICSC_top_0/busy]
  connect_bd_net -net spi3_WICSC_top_0_csb [get_bd_ports csb_0] [get_bd_ports csb_1] [get_bd_pins spi3_WICSC_top_0/csb]
  ...
  connect_bd_net -net spi3_WICSC_top_0_tsc [get_bd_ports tsc_0] [get_bd_pins spi3_WICSC_top_0/tsc]
