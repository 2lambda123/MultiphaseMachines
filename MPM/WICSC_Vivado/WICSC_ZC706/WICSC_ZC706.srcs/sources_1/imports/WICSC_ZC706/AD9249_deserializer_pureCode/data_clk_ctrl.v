...
module data_clock_ctrl # 
   ...
   // Input clock buffer
   //==========================================================================
   IBUFGDS #(.DIFF_TERM("TRUE"), .IBUF_LOW_PWR("FALSE"), .IOSTANDARD("LVDS_25") ) bufds (.I(dco_p), .IB(dco_n), .O(dco_buf));
   
   //==========================================================================
   // Instantiate MMCM frequency counter
   //==========================================================================
   (* keep_hierarchy = "yes" *) mmcm_freq_counter # (                         // Range 5: >R4_MAX 
   ...
   // Reset controller
   //==========================================================================
   (* keep_hierarchy = "yes" *) drp_start_ctrl drp_start_ctrl 
     (// Outputs
      .drp_start                      (drp_start),
      // Inputs
      .reset_n                        (user_reset_n),
