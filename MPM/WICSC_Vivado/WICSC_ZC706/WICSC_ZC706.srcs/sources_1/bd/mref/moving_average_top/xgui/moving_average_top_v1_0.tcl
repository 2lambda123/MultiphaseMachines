...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "Activate" -parent ${Page_0}
...
proc update_PARAM_VALUE.Activate { PARAM_VALUE.Activate } {
	# Procedure called to update Activate when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.Activate { PARAM_VALUE.Activate } {
	# Procedure called to validate Activate
	return true
}
...
proc update_MODELPARAM_VALUE.Activate { MODELPARAM_VALUE.Activate PARAM_VALUE.Activate } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.Activate}] ${MODELPARAM_VALUE.Activate}
}
