...
HD_PWD='C:/MPM_Zynq/spi_master_WICSC/spi_master_WICSC.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log spi3_WICSC_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source spi3_WICSC_top.tcl
