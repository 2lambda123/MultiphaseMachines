...
HD_PWD='C:/Users/JonasHP/Desktop/EXJOBB/WICSC_New/WICSC_ZC706/WICSC_ZC706.runs/design_1_PS_Interface_TOP_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_PS_Interface_TOP_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_PS_Interface_TOP_0_0.tcl
