...
HD_PWD='C:/Users/Pietro/Desktop/Miceli_Pietro/sampling/3_block_diagram/sampling_block_diagram.runs/sampling_bd_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sampling_bd_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sampling_bd_xbar_0.tcl
