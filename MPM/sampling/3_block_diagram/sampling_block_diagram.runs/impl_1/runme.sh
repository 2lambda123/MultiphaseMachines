...
HD_PWD='C:/Users/Pietro/Desktop/Miceli_Pietro/sampling/3_block_diagram/sampling_block_diagram.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sampling_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sampling_bd_wrapper.tcl -notrace
