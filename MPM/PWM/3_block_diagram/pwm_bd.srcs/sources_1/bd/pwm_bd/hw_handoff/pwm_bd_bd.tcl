...
################################################################
# This is a generated script based on design: pwm_bd
#
...
proc create_root_design { parentCell } {
  ...
  set T_out [ create_bd_port -dir O T_out ]
  set clk_8k [ create_bd_port -dir O clk_8k ]
  set configuration_led [ create_bd_port -dir O -from 1 -to 0 configuration_led ]
  set led1 [ create_bd_port -dir O led1 ]
  set led2 [ create_bd_port -dir O led2 ]
  set rst_n [ create_bd_port -dir I -type rst rst_n ]
  set sel_mp [ create_bd_port -dir I -from 1 -to 0 sel_mp ]
  set sw [ create_bd_port -dir O -from 35 -to 0 sw ]

  # Create instance: T_conf_0, and set properties
  set T_conf_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:T_conf:1.0 T_conf_0 ]
  ...
  # Create instance: pwm_at_0, and set properties
  set pwm_at_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:pwm_at:1.0 pwm_at_0 ]
  ...
  connect_bd_net -net T_1 [get_bd_ports T] [get_bd_ports T_out] [get_bd_ports led2] [get_bd_pins T_conf_0/T_in]
  connect_bd_net -net T_conf_0_T_out [get_bd_pins T_conf_0/T_out] [get_bd_pins pwm_at_0/T]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins T_conf_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins pwm_at_0/clk]
  connect_bd_net -net pwm_at_0_clk_8k [get_bd_ports clk_8k] [get_bd_pins pwm_at_0/clk_8k]
  connect_bd_net -net pwm_at_0_sw [get_bd_ports sw] [get_bd_pins pwm_at_0/sw]
  connect_bd_net -net rst_n_1 [get_bd_ports led1] [get_bd_ports rst_n] [get_bd_pins T_conf_0/rst_n] [get_bd_pins pwm_at_0/rst_n]
  connect_bd_net -net sel_mp_1 [get_bd_ports configuration_led] [get_bd_ports sel_mp] [get_bd_pins pwm_at_0/sel_mp]
