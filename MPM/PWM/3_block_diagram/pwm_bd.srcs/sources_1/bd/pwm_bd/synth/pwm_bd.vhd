...
--Date        : Wed Feb 26 20:45:55 2020
--Host        : Pietro running 64-bit major release  (build 9200)
--Command     : generate_target pwm_bd.bd
--Design      : pwm_bd
...
entity pwm_bd is
  port (
    ...
    configuration_led : out STD_LOGIC_VECTOR ( 1 downto 0 );
    led1 : out STD_LOGIC;
    led2 : out STD_LOGIC;
    rst_n : in STD_LOGIC;
  ...
  attribute CORE_GENERATION_INFO of pwm_bd : entity is "pwm_bd,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=pwm_bd,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=3,numReposBlks=3,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_clkrst_cnt=2,da_ps7_cnt=1,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of pwm_bd : entity is "pwm_bd.hwdef";
end pwm_bd;

architecture STRUCTURE of pwm_bd is
  component pwm_bd_processing_system7_0_0 is
  port (
  ...
  end component pwm_bd_processing_system7_0_0;
  component pwm_bd_pwm_at_0_0 is
  port (
    clk : in STD_LOGIC;
    rst_n : in STD_LOGIC;
    sel_mp : in STD_LOGIC_VECTOR ( 1 downto 0 );
  ...
  end component pwm_bd_pwm_at_0_0;
  component pwm_bd_T_conf_0_0 is
  port (
    clk : in STD_LOGIC;
    rst_n : in STD_LOGIC;
    T_in : in STD_LOGIC;
  ...
  end component pwm_bd_T_conf_0_0;
  signal T_1 : STD_LOGIC;
  signal T_conf_0_T_out : STD_LOGIC;
  ...
  signal pwm_at_0_clk_8k : STD_LOGIC;
  signal pwm_at_0_sw : STD_LOGIC_VECTOR ( 35 downto 0 );
  signal rst_n_1 : STD_LOGIC;
  signal sel_mp_1 : STD_LOGIC_VECTOR ( 1 downto 0 );
...
begin
  T_1 <= T;
  T_out <= T_1;
  clk_8k <= pwm_at_0_clk_8k;
  configuration_led(1 downto 0) <= sel_mp_1(1 downto 0);
  led1 <= rst_n_1;
  led2 <= T_1;
  rst_n_1 <= rst_n;
  sel_mp_1(1 downto 0) <= sel_mp(1 downto 0);
  sw(35 downto 0) <= pwm_at_0_sw(35 downto 0);
T_conf_0: component pwm_bd_T_conf_0_0
     port map (
      T_in => T_1,
      T_out => T_conf_0_T_out,
      clk => processing_system7_0_FCLK_CLK0,
      rst_n => rst_n_1
    );
processing_system7_0: component pwm_bd_processing_system7_0_0
     port map (
...
pwm_at_0: component pwm_bd_pwm_at_0_0
     port map (
      T => T_conf_0_T_out,
      clk => processing_system7_0_FCLK_CLK0,
      clk_8k => pwm_at_0_clk_8k,
      rst_n => rst_n_1,
      sel_mp(1 downto 0) => sel_mp_1(1 downto 0),
      sw(35 downto 0) => pwm_at_0_sw(35 downto 0)
    );
end STRUCTURE;
