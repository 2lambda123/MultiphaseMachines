...
HD_PWD='C:/Users/Pietro/Desktop/Miceli_Pietro/PWM/3_block_diagram/pwm_bd.runs/pwm_bd_pwm_at_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pwm_bd_pwm_at_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pwm_bd_pwm_at_0_0.tcl
