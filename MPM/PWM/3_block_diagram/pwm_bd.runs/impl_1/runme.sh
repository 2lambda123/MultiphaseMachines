...
HD_PWD='C:/Users/Pietro/Desktop/Miceli_Pietro/PWM/3_block_diagram/pwm_bd.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pwm_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pwm_bd_wrapper.tcl -notrace
