...
HD_PWD='C:/Users/Pietro/Desktop/Miceli_Pietro/PWM/3_block_diagram/pwm_bd.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pwm_bd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pwm_bd_wrapper.tcl
